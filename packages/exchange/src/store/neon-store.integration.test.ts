 ...
 *
 * Skipped without EXCHANGE_DATABASE_URL, matching how integration tests
...
const DATABASE_URL = process.env.EXCHANGE_DATABASE_URL;

if (!DATABASE_URL) {
  describe.skip("ExchangeStore conformance — NeonStore (no EXCHANGE_DATABASE_URL)", () => {});
} else {
