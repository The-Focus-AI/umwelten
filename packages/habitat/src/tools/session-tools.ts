...
import type { SessionMessage, AssistantMessageEntry, UserMessageEntry } from '@umwelten/core/interaction/types/types.js';
...
import type { LearningKind, LearningProvenance } from '@umwelten/core/session-record/types.js';
