import { BaseModelRunner } from "@umwelten/core/cognition/runner.js";
import { ModelDetails, ModelResponse } from "@umwelten/core/cognition/types.js";
import { Interaction } from "@umwelten/core/interaction/core/interaction.js";
import { Stimulus } from "@umwelten/core/stimulus/stimulus.js";
import { FunctionEvaluationRunner } from "./evaluate.js";
import { calculateCost, CostBreakdown } from "@umwelten/core/costs/costs.js";
import { getAllModels } from "@umwelten/core/cognition/models.js";
  ...
  return async (model: ModelDetails): Promise<ModelResponse> => {
    ...
    if (config.schema) {
      try {
        ...
        const { schemaManager } = await import('@umwelten/core/schema/index.js');
        ...
        if (schema) {
          ...
          try {
            ...
            const { parsedSchemaToZod } = await import('@umwelten/core/schema/index.js');
