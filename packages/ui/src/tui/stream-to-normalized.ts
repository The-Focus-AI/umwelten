...
import type { NormalizedMessage, NormalizedTokenUsage } from '@umwelten/core/interaction/types/normalized-types.js';
import type {
  UserMessageEntry,
...
import { extractTextContent } from '@umwelten/core/interaction/persistence/session-parser.js';
