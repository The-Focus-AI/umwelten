...
import { CLIInterface } from "@umwelten/ui";
import { addCommonOptions, parseCommonOptions } from './commonOptions.js';
import { calculatorTool, statisticsTool, randomNumberTool } from '@umwelten/core/stimulus/tools/index.js';
import { getChatCommands } from '@umwelten/ui/cli/DefaultCommands.js';
