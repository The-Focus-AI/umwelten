...
type Provider = 'openrouter' | 'ollama' | 'google' | 'github-models' | 'fireworks' | 'minimax' | 'deepinfra' | 'togetherai' | 'lmstudio' | 'all';
...
export const modelsCommand = new Command('models')
  ...
  .option('-p, --provider <provider>', 'Filter by provider (openrouter, ollama, google, github-models, fireworks, minimax, deepinfra, togetherai, lmstudio, all)', 'all')
