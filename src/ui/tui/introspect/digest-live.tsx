...
import type { DigestProgress } from '../../../interaction/analysis/session-digester.js';
import { saveDigest } from '../../../introspection/browse.js';
  ...
  const runDigest = async (
    ...
    try {
      const { digestSession } = await import(
        '../../../interaction/analysis/session-digester.js'
      );
