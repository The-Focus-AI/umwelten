...
export declare class ToolValidationError extends Error {
    ...
    constructor(message: string, toolName: string, validationErrors: z.ZodError);
}
 ...
 */
export declare function toVercelTool<T extends z.ZodSchema>(toolDef: ToolDefinition<T>): any;
/**
 ...
 */
export declare function toVercelToolSet(toolSet: ToolSet): Record<string, any>;
