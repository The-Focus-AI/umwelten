...
import { bearerAuth } from "../ui/web/auth/bearer-auth.js";
import { defaultRoutes } from "../ui/web/routes/index.js";
import type { AuthProvider, UserContext, RouteContext, RouteHandler } from "../ui/web/types.js";
